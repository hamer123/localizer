...
/**
 * Created by Patryk on 2016-11-08.
 */
...
class UserResourceTest extends Specification {
    ...
    def "should find user and return user-last-locations-dto and 200 code"() {
        ...
        with(json) {
            JsonPath.read(json, '$.lastLocationGps.id') == 1
            JsonPath.read(json, '$.lastLocationGps.latitude') == 123.123
            JsonPath.read(json, '$.lastLocationGps.longitude') == 321.321
            JsonPath.read(json, '$.lastLocationNetworkNasz') == null
            JsonPath.read(json, '$.lastLocationNetworkNasz') == null
        }
    }
